...
```
ffmpeg -thread_queue_size 16 -i "直播源URL" -c:v libx265 -preset ultrafast -tune zerolatency -c:a aac -strict experimental -f flv rtmp://your_rtmp_server/live/stream_key
```
